                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form action="{{route('edit-user/'.$users->id)}}" method="post">
                                            ...
                                            <input type="text" name="name" class="form-control " value="{{$users->user}}">

                                            <label for="pass" class="mt-3">Pass</label>
                                            <input type="text" name="pass" class="form-control" value="{{$users->pass}}">
                                            ...
                                            <input type="text" name="tel" class="form-control" value="{{$users->tel}}">
